...
class ClimasController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let infoBook = self.sincrono(codigo)
        
        self.tempLbl.text = codigo
        
        bookTitle.text = infoBook.title
        bookAutor.text = infoBook.autor
        
        
        if let url  = NSURL(string: infoBook.img),
