...
//  JSON_
//
//  Created by Telecomunicaciones Abiertas de México on 1/21/16.
...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var panelTxtView: UILabel!
    @IBOutlet weak var autor: UILabel!
    @IBOutlet weak var cover: UIImageView!
    
    func sincrono(var ISBN: String) -> (error: Int, errorCode: String, title: String, autor: String, img: String) {
        
        ISBN = ISBN.stringByTrimmingCharactersInSet(NSCharacterSet.whitespaceCharacterSet())
    ...
    @IBAction func mm(sender: AnyObject) {
        ...
        //print(openLib)
        if (openLib.error == 0){
            panelTxtView.text = openLib.title
            autor.text = openLib.autor
            
            
            if let url  = NSURL(string: openLib.img),
            ...
            autor.text = openLib.autor
            cover.image = nil
            let alert = UIAlertController(title: "Alerta", message: openLib.errorCode, preferredStyle: .Alert)
